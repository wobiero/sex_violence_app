...
st.markdown("# Sexual and Gender Based Violence Time Series Analysis Tool")
...
#         st.write(fig)
        ...
        """
        This function uses the causal impact library to construct
        ...
        plt.plot(ci.inferences.index[1:], ci.inferences["point_effects"][1:], c="k", label="Point Effects")
        ...
        fig, ax = plt.subplots(figsize=(10,5), dpi=200)
        plt.plot(ci_data.index, ci_data["post_cum_effects"], ls="--", color="k", label="Cumulative Effects")
